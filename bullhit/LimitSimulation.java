...
public class LimitSimulation extends Simulation {
  ...
  private ScenarioBuilder scn = scenario("LimitSimulation")
    .exec(
      http("request_0")
...

  {
      setUp(
          scn.injectClosed(
              rampConcurrentUsers(0).to(8292).during(60),
              constantConcurrentUsers(8292).during(60),
              rampConcurrentUsers(8292).to(0).during(60)
          )
