...
public class StressSimulation extends Simulation {
...

  {
      setUp(
          scn.injectClosed(
              rampConcurrentUsers(0).to(8000).during(30),
              rampConcurrentUsers(8000).to(14000).during(30),
              rampConcurrentUsers(14000).to(20000).during(30),
              rampConcurrentUsers(20000).to(26000).during(30),
              rampConcurrentUsers(26000).to(32000).during(30),
              rampConcurrentUsers(32000).to(38000).during(30)
          )
